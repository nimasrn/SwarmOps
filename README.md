...
To build directly from a reviewed source checkout instead, run:
...
Docker, single-node Swarm, CIDR-scoped UFW, and Docker registry-mirror
operations. It never prints the
generated API key.
