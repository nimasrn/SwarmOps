 ...
 * screen reader.
 */
export declare function Panel({ actions, children, className, description, eyebrow, flush, footer, title, ...props }: PanelProps): import("react").JSX.Element;
 ...
 */
export declare function Metric({ className, delta, deltaDirection, deltaIntent, hint, icon, label, onClick, tone, value, ...props }: MetricProps): import("react").JSX.Element;
...
export declare function MetricGrid({ children, className, columns, ...props }: MetricGridProps): import("react").JSX.Element;
