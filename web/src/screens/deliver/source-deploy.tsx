...
import { DeploymentPlan } from './source/plan'
import { RegistryBoundaryPage } from './source/registry'
import { SourceSetupPanel } from './source/setup'
import {
  DiscoveryEvidence,
  connectionColumns,
...
export function SourceDeployPage({ managerID, managerName, toast, view = 'source' }: SourceDeployPageProps) {
  ...
  if (!status) {
    ...
    return error
      ...
      : <Screen page="source-deploy"><Panel><Spinner label="Reading source deployment capability" /></Panel></Screen>
  }
